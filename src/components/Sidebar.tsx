...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col gap-3 md:h-screen w-full md:w-xs">
      <div className="bg-white rounded-md overflow-hidden h-max pb-6 border">
        <div className="h-24 w-full bg-stone-300 bg-[url(/vines.webp)] bg-cover">
          <Avatar className="relative top-12 left-6 cursor-pointer size-20 mb-2 border shadow-sm">
